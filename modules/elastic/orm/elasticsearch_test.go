...
type MyHost struct {
	Host        string         `json:"host,omitempty" elastic_meta:"_id" elastic_mapping:"address: { type: \"text\", fields: { keyword: { type: \"keyword\", ignore_above: 256 } } }"`
	Favicon     string         `json:"favicon,omitempty" elastic_mapping:"favicon: { type: \"keyword\" }"`
