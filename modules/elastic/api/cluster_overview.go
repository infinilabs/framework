...
func (h *APIHandler) SearchClusterMetadata(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
	...
	histgram=common.NewBucketItem(
		common.DateHistogramBucket,util.MapStr{
			"field": "timestamp",
			"calendar_interval": bucketSizeStr,
			"time_zone": "+08:00",
		})

	histgram.AddNestBucket(common.NewBucketItem(common.TermsBucket,util.MapStr{
	...
	d1=append(d1,[]interface{}{1613898840000,"green"})
	d1=append(d1,[]interface{}{1613898840000,"red"})
	d1=append(d1,[]interface{}{1613898840000,""})
	d1=append(d1,[]interface{}{1613898840000,""})
	d1=append(d1,[]interface{}{1613898840000,"red"})
	d1=append(d1,[]interface{}{1613898840000,"yellow"})
	d1=append(d1,[]interface{}{1613898840000,"red"})
	d1=append(d1,[]interface{}{1613898840000,"red"})
