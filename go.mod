...
replace github.com/cihub/seelog => ./lib/seelog

// clashx is a fork of Dreamacro/clash that keeps the original module path,
// so it must be pulled through a replace directive.
replace github.com/Dreamacro/clash => github.com/chwjbn/clashx v1.18.1-0.20230817150358-e5f2396f810a

require (
	github.com/Dreamacro/clash v1.18.1-0.20230817150358-e5f2396f810a
